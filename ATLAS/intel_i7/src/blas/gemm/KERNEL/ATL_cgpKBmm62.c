...
static void ATL_cJIK0x0x62TN1x1x6_a1_bX
 ...
 * lda=62, ldb=62, ldc=0, mu=1, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   #define incAk 6
   const int incAm = 2, incAn = -(62*(Mb));
   #define incBk 6
   const int incBm = -60, incBn = 62;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=62, 
 * lda=62, ldb=62, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 684, incAn = -(62*(Mb));
   #define incBk 6
   const int incBm = -60, incBn = 62;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x62TN1x1x6_a1_bX(k, N, 62, alpha, ca + (62*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
