...
static void ATL_dJIK0x0x10TN1x1x4_a1_bX
 ...
 * lda=10, ldb=10, ldc=0, mu=1, nu=1, ku=4, pf=1
 ...
 */
{
   ...
   #define incAk 4
   const int incAm = 2, incAn = -(((Mb) << 3)+((Mb) << 1));
   #define incBk 4
   const int incBm = -8, incBn = 10;
   #define incCm 1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=10, 
 * lda=10, ldb=10, ldc=0, mu=12, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 4
   const int incAm = 112, incAn = -(((Mb) << 3)+((Mb) << 1));
   #define incBk 4
   const int incBm = -8, incBn = 10;
   #define incCm 12
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x10TN1x1x4_a1_bX(k, N, 10, alpha, ca + (((Mb) << 3)+((Mb) << 1)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
