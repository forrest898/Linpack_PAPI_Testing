...
static void ATL_cJIK0x0x73TN1x1x6_a1_bX
 ...
 * lda=73, ldb=73, ldc=0, mu=1, nu=1, ku=6, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=73, 
 * lda=73, ldb=73, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x73TN1x1x6_a1_bX(k, N, 73, alpha, ca + (73*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
