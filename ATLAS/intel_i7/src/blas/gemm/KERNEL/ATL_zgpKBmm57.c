...
static void ATL_zJIK0x0x57TN1x1x6_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x57TN57x57x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=57, 
 * lda=57, ldb=57, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 630, incAn = -(57*(Mb));
   #define incBk 6
   const int incBm = -54, incBn = 57;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x57TN1x1x6_a1_bX(k, N, 57, alpha, ca + (57*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
