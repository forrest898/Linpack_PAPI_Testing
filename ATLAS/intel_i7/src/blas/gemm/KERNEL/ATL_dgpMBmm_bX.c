...
static void ATL_dJIK0x56x56TN1x1x4_a1_bX
 ...
 * lda=56, ldb=56, ldc=0, mu=1, nu=1, ku=4, pf=1
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_dJIK0x56x56TN1x1x4_a1_bX(k, 56, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
