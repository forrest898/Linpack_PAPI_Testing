...
static void ATL_dJIK0x0x35TN1x1x4_a1_bX
 ...
 * lda=35, ldb=35, ldc=0, mu=1, nu=1, ku=4, pf=1
 ...
 */
{
   ...
   #define incAk 4
   const int incAm = 3, incAn = -(35*(Mb));
   #define incBk 4
   const int incBm = -32, incBn = 35;
   #define incCm 1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=35, 
 * lda=35, ldb=35, ldc=0, mu=12, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 4
   const int incAm = 388, incAn = -(35*(Mb));
   #define incBk 4
   const int incBm = -32, incBn = 35;
   #define incCm 12
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x35TN1x1x4_a1_bX(k, N, 35, alpha, ca + (35*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
