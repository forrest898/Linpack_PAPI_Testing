...
static void ATL_dJIK0x0x38TN1x1x4_a1_bX
 ...
 * lda=38, ldb=38, ldc=0, mu=1, nu=1, ku=4, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=38, 
 * lda=38, ldb=38, ldc=0, mu=12, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x38TN1x1x4_a1_bX(k, N, 38, alpha, ca + (38*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
