...
static void ATL_cJIK0x0x68TN1x1x6_a1_bX
 ...
 * lda=68, ldb=68, ldc=0, mu=1, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   #define incAk 6
   const int incAm = 2, incAn = -(((Mb) << 6)+((Mb) << 2));
   #define incBk 6
   const int incBm = -66, incBn = 68;
   #define incCm 2
   ...
   do /* N-loop */
   {
      do /* M-loop */
      {
         ...
         rC0_0 = *pC0;
         rC0_0 *= rA0;
         for (k=0; k < 11; k++) /* easy loop to unroll */
         {
            rA0 = *pA0;
            rB0 = *pB0;
            rC0_0 += rA0 * rB0;
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=68, 
 * lda=68, ldb=68, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 750, incAn = -(((Mb) << 6)+((Mb) << 2));
   #define incBk 6
   const int incBm = -66, incBn = 68;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x68TN1x1x6_a1_bX(k, N, 68, alpha, ca + (((Mb) << 6)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
