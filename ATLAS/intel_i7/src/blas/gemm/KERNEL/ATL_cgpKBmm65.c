...
static void ATL_cJIK0x0x65TN1x1x6_a1_bX
 ...
 * lda=65, ldb=65, ldc=0, mu=1, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   #define incAk 6
   const int incAm = 5, incAn = -(((Mb) << 6)+Mb);
   #define incBk 6
   const int incBm = -60, incBn = 65;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=65, 
 * lda=65, ldb=65, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 720, incAn = -(((Mb) << 6)+Mb);
   #define incBk 6
   const int incBm = -60, incBn = 65;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x65TN1x1x6_a1_bX(k, N, 65, alpha, ca + (((Mb) << 6)+Mb), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
