...
static void ATL_CupNBmm0_5_0_b0
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupNBmm0_5_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_cupNBmm0_5_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupNBmm0_3_0_b0
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupNBmm0_3_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_cupNBmm0_3_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupNBmm0_2_0_b0
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupNBmm0_2_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_cupNBmm0_2_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
...
static void ATL_CupNBmm0_1_0_b0
   (const int M, const int N, const int K, const float alpha,
    const float *A, const int lda, const float *B, const int ldb,
    const float beta, float *C, const int ldc)
{
   const float *rA = A + lda*M, *rB = B + ldb*N;
   ATL_cupNBmm0_1_0_b0(M, N, K, alpha, A, lda, B, ldb, ATL_rzero, C, ldc); 
   ATL_cupNBmm0_1_0_b0(M, N, K, alpha, A, lda, rB, ldb, beta, C+1, ldc); 
