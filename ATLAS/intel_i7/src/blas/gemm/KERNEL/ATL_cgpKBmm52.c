...
static void ATL_cJIK0x0x52TN1x1x6_a1_bX
 ...
 * lda=52, ldb=52, ldc=0, mu=1, nu=1, ku=6, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 * lda=52, ldb=52, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 576, incAn = -(52*(Mb));
   #define incBk 6
   const int incBm = -48, incBn = 52;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x52TN1x1x6_a1_bX(k, N, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
