...
static void ATL_cJIK8x0x80TN8x1x6_a1_bX
 ...
 * lda=80, ldb=80, ldc=0, mu=8, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 882, incAn = -5760;
   #define incBk 6
   const int incBm = -78, incBn = 80;
   #define incCm 24
   ...
   while(pB0 != stN);
   ATL_cJIK8x0x80TN8x1x6_a1_bX(8, N, 80, alpha, ca + 5760, lda, cb, ldb, beta, cc + 144, ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
static void ATL_cJIK8x0x80TN8x1x6_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=8, NB=0, KB=80, 
 * lda=80, ldb=80, ldc=0, mu=8, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   while(pB0 != stN);
   ATL_cJIK8x0x80TN8x1x6_a1_b1(8, N, 80, alpha, ca + 5760, lda, cb, ldb, beta, cc + 144, ldc);
}
#ifdef incAm
   #undef incAm
#endif
