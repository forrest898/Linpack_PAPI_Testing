...
static void ATL_cJIK0x0x19TN1x1x6_a1_bX
 ...
 * lda=19, ldb=19, ldc=0, mu=1, nu=1, ku=6, pf=1
 ...
 */
{
   ...
   #define incAk 6
   const int incAm = 1, incAn = -(19*(Mb));
   #define incBk 6
   const int incBm = -18, incBn = 19;
   #define incCm 2
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=19, 
 * lda=19, ldb=19, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 6
   const int incAm = 210, incAn = -(19*(Mb));
   #define incBk 6
   const int incBm = -18, incBn = 19;
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x19TN1x1x6_a1_bX(k, N, 19, alpha, ca + (19*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
