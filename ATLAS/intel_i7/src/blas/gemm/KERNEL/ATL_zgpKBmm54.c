...
static void ATL_zJIK0x0x54TN1x1x6_a1_bX
 ...
 * lda=54, ldb=54, ldc=0, mu=1, nu=1, ku=6, pf=1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=54, 
 * lda=54, ldb=54, ldc=0, mu=12, nu=1, ku=6, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x54TN1x1x6_a1_bX(k, N, 54, alpha, ca + (54*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
