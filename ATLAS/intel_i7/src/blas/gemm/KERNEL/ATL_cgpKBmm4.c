...
static void ATL_cJIK0x0x4TN1x1x4_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x4TN4x4x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=4, 
 * lda=4, ldb=4, ldc=0, mu=12, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x4TN1x1x4_a1_bX(k, N, 4, alpha, ca + (((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
