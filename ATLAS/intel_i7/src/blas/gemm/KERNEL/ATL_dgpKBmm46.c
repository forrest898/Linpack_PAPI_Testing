...
static void ATL_dJIK0x0x46TN1x1x4_a1_bX
 ...
 * lda=46, ldb=46, ldc=0, mu=1, nu=1, ku=4, pf=1
 ...
 */
{
   ...
   #define incAk 4
   const int incAm = 2, incAn = -(46*(Mb));
   #define incBk 4
   const int incBm = -44, incBn = 46;
   #define incCm 1
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=46, 
 * lda=46, ldb=46, ldc=0, mu=12, nu=1, ku=4, pf=1
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.10.3)
 */
{
   ...
   const int incPFA = (1 > incPFA0) ? 1 : incPFA0;
   #define incAk 4
   const int incAm = 508, incAn = -(46*(Mb));
   #define incBk 4
   const int incBm = -44, incBn = 46;
   #define incCm 12
   const int incCn = (ldc) - (Mb);
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x46TN1x1x4_a1_bX(k, N, 46, alpha, ca + (46*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
