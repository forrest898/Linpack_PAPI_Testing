                 ...
                 const TYPE beta, TYPE *C, const ATL_INT ldc )
{
   ...
   register void const * prefetchABlock =  (void*)(A + 80*KB); 
   ...
   const ATL_INT pfBlockDistance = (4 * 2 * KB * 4) / 80;
   /* =======================================
   ...
   for( j=-80; j!=0; j+=J_UNROLL) 
   {
      ...
      for( i=-80; i != 0; i+= I_UNROLL )
      {
         ...
         A3 = _mm_load_ps( MMCAST(A0_off + 304) );
         ...
         A2 = _mm_load_ps( MMCAST(A0_off + 228) );
         A3 = _mm_load_ps( MMCAST(A0_off + 308) );
         ...
         A1 = _mm_load_ps( MMCAST(A0_off + 152) );
         A2 = _mm_load_ps( MMCAST(A0_off + 232) );
         A3 = _mm_load_ps( MMCAST(A0_off + 312) );
         ...
         B1 = _mm_load_ps( MMCAST(B0_off + 152) );
         A0 = _mm_mul_ps( B1, A0 );
         c1_0 = _mm_add_ps( A0, c1_0 );
         A1 = _mm_mul_ps( B1, A1 );
         c1_1 = _mm_add_ps( A1, c1_1 );
         ...
         c1_3 = _mm_add_ps( A3, c1_3 );
         /* K_Unrolling: 76 */
         A0 = _mm_load_ps( MMCAST(A0_off + 76) );
         A1 = _mm_load_ps( MMCAST(A0_off + 156) );
         A2 = _mm_load_ps( MMCAST(A0_off + 236) );
         A3 = _mm_load_ps( MMCAST(A0_off + 316) );
         
         B0 = _mm_load_ps( MMCAST(B0_off + 76) );
         a0 = A0;
         a0 = _mm_mul_ps( B0, a0 );
         c0_0 = _mm_add_ps( a0, c0_0 );
         a1 = A1;
         ...
         B1 = _mm_load_ps( MMCAST(B0_off + 156) );
         A0 = _mm_mul_ps( B1, A0 );
         c1_0 = _mm_add_ps( A0, c1_0 );
         A1 = _mm_mul_ps( B1, A1 );
         c1_1 = _mm_add_ps( A1, c1_1 );
