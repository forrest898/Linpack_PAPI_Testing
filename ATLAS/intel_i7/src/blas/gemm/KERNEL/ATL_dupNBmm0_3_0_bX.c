#define ATL_USERMM ATL_dupNBmm0_3_0_bX
#define ATL_USERMM_b1 ATL_dupNBmm0_3_0_b1
#define ATL_USERMM_bn1 ATL_dupNBmm0_3_0_bn1
#define ATL_USERMM_b0 ATL_dupNBmm0_3_0_b0
#define ATL_USERMM_bX ATL_dupNBmm0_3_0_bX
#define BETAX
#define DREAL
 ...
 */
{
   ...
   #endif
   const size_t incAm = (lda<<2), incBn = ldb*3;
   const size_t incC=ldc2*3;
   #if !defined(BETA0) && !defined(BETA1) && !defined(TCPLX)
      ATL_vbcast(vBE, &beta);
   #endif
 ...
 */
                ...
                && defined(SREAL)
         {
            ...
            _mm_storeu_ps(pC0+ldc2, _mm256_extractf128_ps(rC00, 1));
            {
               __m128 c0, c1, cBE;
               ATL_vvrsum4(rC02, rC12, rC22, rC32)
               c0 = _mm256_extractf128_ps(rC02, 0);
               #ifndef BETA0
                  c1 = _mm_loadu_ps(pC2);
                  #ifdef BETAX
