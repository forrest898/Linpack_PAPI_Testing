...
static void ATL_cJIK0x0x48TN1x1x4_aX_bX
 ...
 */
{
   ...
   #define incAk 8
   const int incAm = ((((lda) - 48) << 1)), incAn = -(((Mb*lda) << 1));
   #define incBk 8
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x48TN0x0x0_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=48, 
 ...
 */
{
   ...
   const float BetaAlpha = beta / alpha;
   #define incAk 8
   const int incAm = ((((((lda) << 3)+((lda) << 2)) - 48) << 1)), incAn = -(((Mb*lda) << 1));
   #define incBk 8
   const int incBm = -96, incBn = (((ldb) << 1));
   #define incCm 24
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x48TN1x1x4_aX_bX(k, N, 48, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
