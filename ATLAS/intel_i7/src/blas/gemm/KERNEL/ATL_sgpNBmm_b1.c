#ifdef ATL_UCLEANN
#define ATL_sJIK80x0x80TN80x80x0_a1_b1 ATL_sgpNBmm_b1
#else
#define ATL_sJIK80x0x80TN80x80x0_a1_b1 ATL_spNBmm_b1
#endif
...
#endif
#endif
static void ATL_sJIK80x0x80TN2x1x1_a1_b1
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_sJIK80x0x80TN80x80x0_a1_b1
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=80, NB=0, KB=80, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK80x0x80TN2x1x1_a1_b1(80, k, 80, alpha, ca, lda, cb + (((Nb) << 6)+((Nb) << 4)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
