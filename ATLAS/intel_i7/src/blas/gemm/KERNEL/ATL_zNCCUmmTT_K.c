...
static void ATL_zJIK0x0x24TT1x1x1_aX_bX
 ...
 */
{
   ...
   do /* N-loop */
   {
      ...
      do /* M-loop */
      {
         ...
         rC0_0 = *pC0;
         rC0_0 *= rA0;
         for (k=0; k < 24; k++) /* easy loop to unroll */
         {
            rA0 = *pA0;
            rB0 = *pB0;
            rC0_0 += rA0 * rB0;
   ...
   #undef Kb
#endif
void ATL_zJIK0x0x24TT0x0x0_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=24, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_zJIK0x0x24TT1x1x1_aX_bX(k, N, 24, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
